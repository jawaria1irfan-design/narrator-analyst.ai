...
## 📁 Project Structure
<img width="886" height="331" alt="image" src="https://github.com/user-attachments/assets/eb84cd84-34f0-4573-898f-a1bbad30b81f" />
...
Create a `.env` file in the root folder and add your Groq API key (no quotes):
```text
...
> **Note:** The app is hosted on Streamlit's free tier. If you see a "Zzzz" sleeping screen, simply click **"Yes, get this app back up!"** and it will load within 60 seconds.
...
> **Development Note:** This project was initially developed using GitHub Copilot for AI-assisted coding. As Copilot credits were exhausted during development, additional AI assistant tools were utilized to complete the project. The core development workflow remained AI-assisted throughout.
